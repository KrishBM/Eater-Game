...
//        StartCoroutine(stop());
    ...
    private void OnCollisionEnter2D(Collision2D collision)
    {
        ...
        else if (collision.gameObject.tag == "food")
        {
            ...
            if (score == 2)
            {
                booms[0].transform.position = new Vector3(Random.Range(-2.4f, 2.4f), Random.Range(-4.5f, 4.0f), 0);
            ...
            if (score == 4)
            {
                booms[1].transform.position = new Vector3(Random.Range(-2.4f, 2.4f), Random.Range(-4.5f, 4.0f), 0);
            ...
            if (score == 6)
            {
                booms[2].transform.position = new Vector3(Random.Range(-2.4f, 2.4f), Random.Range(-4.5f, 4.0f), 0);
            ...
            if (score == 8)
            {
                booms[3].transform.position = new Vector3(Random.Range(-2.4f, 2.4f), Random.Range(-4.5f, 4.0f), 0);
            ...
            if (score == 10)
            {
                booms[4].transform.position = new Vector3(Random.Range(-2.4f, 2.4f), Random.Range(-4.5f, 4.0f), 0);
            ...
            if (score == 12)
            {
                booms[5].transform.position = new Vector3(Random.Range(-2.4f, 2.4f), Random.Range(-4.5f, 4.0f), 0);
            ...
            if (score == 14)
            {
                booms[6].transform.position = new Vector3(Random.Range(-2.4f, 2.4f), Random.Range(-4.5f, 4.0f), 0);
